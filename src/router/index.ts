...
const routes = [
  ...
  { path: '/dashboard', name: 'dashboard', component: () => import('@/views-modern/SystemStatusPage.vue'), meta: { admin: true } },
  { path: '/dashboard/files', name: 'dashboardFiles', component: () => import('@/views-modern/DashboardPage.vue'), meta: { admin: true } },
  { path: '/dashboard/users', name: 'dashboardUsers', component: () => import('@/views-modern/UserManagementPage.vue'), meta: { admin: true } },
  { path: '/dashboard/settings', name: 'dashboardSettings', component: () => import('@/views-modern/SystemSettingsPage.vue'), meta: { admin: true } },
  { path: '/dashboard/access', name: 'dashboardAccess', component: () => import('@/views-modern/AccessSettingsPage.vue'), meta: { admin: true } },
  { path: '/systemConfig', redirect: '/dashboard/settings' },
  { path: '/customerConfig', redirect: '/dashboard/users' },
